...
* [`src/bball_ui/`](src/bball_ui/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/bball_ui/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `bball-ui` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/bball_ui/config.cljs) defaults to `true` in
...
```clj
(ns bball-ui.example
  (:require [bball-ui.config :as config])
